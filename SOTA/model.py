...
from mozaik.connectors.modular import (
    LogNormalModularSamplingProbabilisticConnector,
    LogNormalModularSamplingProbabilisticConnectorAnnotationSamplesCount,
)
...
class SelfSustainedPushPull(Model):
    ...
    def __init__(self, sim, num_threads, parameters):
        ...
        if not self.parameters.only_afferent:
            ...
            LogNormalModularSamplingProbabilisticConnector(self, 'V1L4InhL4ExcConnection', cortex_inh_l4,
                                                           cortex_exc_l4, self.parameters.sheets.l4_cortex_inh.L4InhL4ExcConnection).connect()
            LogNormalModularSamplingProbabilisticConnector(self, 'V1L4InhL4InhConnection', cortex_inh_l4,
            ...
            if self.parameters.l23:
                ...
                LogNormalModularSamplingProbabilisticConnector(self, 'V1L4ExcL23ExcConnection', cortex_exc_l4,
                                                               cortex_exc_l23, self.parameters.sheets.l23_cortex_exc.L4ExcL23ExcConnection).connect()
                LogNormalModularSamplingProbabilisticConnector(self, 'V1L4ExcL23InhConnection', cortex_exc_l4,
                                                               cortex_inh_l23, self.parameters.sheets.l23_cortex_inh.L4ExcL23InhConnection).connect()

                LogNormalModularSamplingProbabilisticConnector(self, 'V1L23ExcL23ExcConnection', cortex_exc_l23,
                                                               cortex_exc_l23, self.parameters.sheets.l23_cortex_exc.L23ExcL23ExcConnection).connect()
                LogNormalModularSamplingProbabilisticConnector(self, 'V1L23ExcL23InhConnection', cortex_exc_l23,
                                                               cortex_inh_l23, self.parameters.sheets.l23_cortex_exc.L23ExcL23InhConnection).connect()
                LogNormalModularSamplingProbabilisticConnector(self, 'V1L23InhL23ExcConnection', cortex_inh_l23,
                                                               cortex_exc_l23, self.parameters.sheets.l23_cortex_inh.L23InhL23ExcConnection).connect()
                LogNormalModularSamplingProbabilisticConnector(self, 'V1L23InhL23InhConnection', cortex_inh_l23,
                                                               cortex_inh_l23, self.parameters.sheets.l23_cortex_inh.L23InhL23InhConnection).connect()
                if self.parameters.feedback:
                    LogNormalModularSamplingProbabilisticConnector(self, 'V1L23ExcL4ExcConnection', cortex_exc_l23,
                                                                   cortex_exc_l4, self.parameters.sheets.l23_cortex_exc.L23ExcL4ExcConnection).connect()
                    LogNormalModularSamplingProbabilisticConnector(self, 'V1L23ExcL4InhConnection', cortex_exc_l23,
