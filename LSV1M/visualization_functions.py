...
class SpontActOverview(Plotting):
    ...
    def subplot(self, subplotspec):
        ...
        plots['InhL4Cond'] = (GSynPlot(dsv, ParameterSet({'sheet_name' : 'V1_Inh_L4', 'neuron' : self.parameters.l4_inh_neuron, 'spontaneous' : False})),gs[6,1:],{'x_label': None,'fontsize' : fontsize, 'x_ticks' : [],'title' : None,'x_lim' : (0,tstop),'y_lim' : (0,15)})
...
class SpontStatisticsOverview(Plotting):
    ...
    def subplot(self, subplotspec):
        ...
        if True:
            ...
            r1 = pylab.barh(numpy.array([0.17,0.67]),[mean_CV_L4E,mean_CV_L23E],height = 0.12,color='#000000',edgecolor='#000000',xerr=[std_CV_L4E,std_CV_L23E],error_kw=dict(ecolor='gray', lw=2, capsize=5, capthick=2))
            r2 = pylab.barh(numpy.array([0.33,0.83]),[mean_CV_L4I,mean_CV_L23I],height = 0.12,color='#FFFFFF',edgecolor='#000000',xerr=[std_CV_L4I,std_CV_L23I],error_kw=dict(ecolor='gray', lw=2, capsize=5, capthick=2))
            pylab.ylim(0,1.0)
            pylab.xlim(0,2.0)
            pylab.yticks([0.25,0.75],['L4','L2/3'])
            ...
            r1 = pylab.barh(numpy.array([0.17,0.67]),[mean_CC_L4E,mean_CC_L23E],height = 0.12,color='#000000',edgecolor='#000000',xerr=[std_CC_L4E,std_CC_L23E],error_kw=dict(ecolor='gray', lw=2, capsize=5, capthick=2))
            r2 = pylab.barh(numpy.array([0.33,0.83]),[mean_CC_L4I,mean_CC_L23I],height = 0.12,color='#FFFFFF',edgecolor='#000000',xerr=[std_CC_L4I,std_CC_L23I],error_kw=dict(ecolor='gray', lw=2, capsize=5, capthick=2))
            pylab.ylim(0,1.0)
            pylab.xlim(0,0.15)
            pylab.yticks([0.25,0.75],['L4','L2/3'])
            ...
            r1 = pylab.barh(numpy.array([0.17,0.67]),[abs(mean_VM_L4E),numpy.abs(mean_VM_L23E)],height = 0.12,color='#000000',edgecolor='#000000',xerr=[std_VM_L4E,std_VM_L23E],error_kw=dict(ecolor='gray', lw=2, capsize=5, capthick=2))
            r2 = pylab.barh(numpy.array([0.33,0.83]),[abs(mean_VM_L4I),numpy.abs(mean_VM_L23I)],height = 0.12,color='#FFFFFF',edgecolor='#000000',xerr=[std_VM_L4I,std_VM_L23I],error_kw=dict(ecolor='gray', lw=2, capsize=5, capthick=2))
            pylab.ylim(0,1.0)
            pylab.xlim(40,80)
            ...
            r1 = pylab.barh(numpy.array([0.17,0.67]),[mean_CondE_L4E*1000,mean_CondE_L23E*1000],height = 0.12,color='#000000',edgecolor='#000000',xerr=[std_CondE_L4E*1000,std_CondE_L23E*1000],error_kw=dict(ecolor='gray', lw=2, capsize=5, capthick=2))
            r2 = pylab.barh(numpy.array([0.33,0.83]),[mean_CondE_L4I*1000,mean_CondE_L23I*1000],height = 0.12,color='#FFFFFF',edgecolor='#000000',xerr=[std_CondE_L4I*1000,std_CondE_L23I*1000],error_kw=dict(ecolor='gray', lw=2, capsize=5, capthick=2))
            pylab.ylim(0,1.0)
            pylab.xlim(0,2.0)
            pylab.yticks([0.25,0.75],['L4','L2/3'])
            ...
            r1 = pylab.barh(numpy.array([0.17,0.67]),[mean_CondI_L4E*1000,mean_CondI_L23E*1000],height = 0.12,color='#000000',edgecolor='#000000',xerr=[std_CondI_L4E*1000,std_CondI_L23E*1000],error_kw=dict(ecolor='gray', lw=2, capsize=5, capthick=2))
            r2 = pylab.barh(numpy.array([0.33,0.83]),[mean_CondI_L4I*1000,mean_CondI_L23I*1000],height = 0.12,color='#FFFFFF',edgecolor='#000000',xerr=[std_CondI_L4I*1000,std_CondI_L23I*1000],error_kw=dict(ecolor='gray', lw=2, capsize=5, capthick=2))
            pylab.ylim(0,1.0)
            pylab.xlim(0,10)
            pylab.yticks([0.25,0.75],['L4','L2/3'])
...
class SizeTuningRingOverview(Plotting):
    ...
    def subplot(self, subplotspec):
        ...
        dsv = param_filter_query(
            self.datastore, st_name='DriftingSinusoidalGratingRing', value_name=['Firing rate'])
        plots['L4ExcFR'] = (PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'inner_aperture_radius', 'neurons': self.parameters.l4_neurons, 'sheet_name': 'V1_Exc_L4', 'centered': False, 'mean': True, 'polar': False, 'pool': False})), gs[0:4, 0:4], {
        ...
        if self.parameters.l23_neurons != []:
            plots['L23ExcFR'] = (PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'inner_aperture_radius', 'neurons': self.parameters.l23_neurons, 'sheet_name': 'V1_Exc_L2/3', 'centered': False, 'mean': True, 'polar': False, 'pool': False})), gs[4:8, 0:4], {
        ...
        # (x+y)(F1_Vm,-(x+y)(F0_Vm,Mean(VM)))
        dsv = param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', value_name=[
                                 '-(x+y)(F0_Vm,Mean(VM))'])
        plots['L4ExcVm'] = (PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'inner_aperture_radius', 'neurons': self.parameters.l4_neurons_analog, 'sheet_name': 'V1_Exc_L4', 'centered': False, 'mean': True, 'polar': False, 'pool': False})), gs[0:4, 5:9], {
        ...
        if self.parameters.l23_neurons != []:
            dsv = param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', value_name=[
                                     '-(x+y)(F0_Vm,Mean(VM))'])
            plots['L23ExcVm'] = (PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'inner_aperture_radius', 'neurons': self.parameters.l23_neurons_analog, 'sheet_name': 'V1_Exc_L2/3', 'centered': False, 'mean': True,
        ...
        #dsv = param_filter_query(self.datastore,st_name='DriftingSinusoidalGratingRing',value_name=['(x+y)(F0_Exc_Cond,F1_Exc_Cond)','(x+y)(F0_Inh_Cond,F1_Inh_Cond)'])
        plots['L4ExcCond,'] = (PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'inner_aperture_radius', 'neurons': self.parameters.l4_neurons_analog, 'sheet_name': 'V1_Exc_L4', 'centered': False, 'mean': True, 'polar': False, 'pool': True})), gs[0:4, 20:24], {
        ...
        if self.parameters.l23_neurons != []:
            ...
            #dsv = param_filter_query(self.datastore,st_name='DriftingSinusoidalGratingRing',value_name=['(x+y)(F0_Exc_Cond,F1_Exc_Cond)','(x+y)(F0_Inh_Cond,F1_Inh_Cond)'])
            plots['L23ExcCond'] = (PlotTuningCurve(dsv, ParameterSet({'parameter_name': 'inner_aperture_radius', 'neurons': self.parameters.l23_neurons_analog, 'sheet_name': 'V1_Exc_L2/3', 'centered': False, 'mean': True, 'polar': False, 'pool': True})), gs[4:8, 20:24], {
...
class RingDiskOverview(Plotting):
    """
    The analysis of size tuning in the model for both annulus and disk experiment.
    ...
    sheet_name: str
           The name of the sheet to which the neurons belong
    population: bool
           True to visualize population data, False for visualizing plots for each neurons individually
    """
    ...
    def subplot(self, subplotspec):
        if self.parameters.population:
            return LinePlot(function=self._ploter, length=1, horizontal=False).make_line_plot(subplotspec)
        else:
            return LinePlot(function=self._ploter, length=len(self.parameters.neurons), horizontal=False).make_line_plot(subplotspec)

    def _ploter(self, idx, gs):

        plots = []
        gs = gridspec.GridSpecFromSubplotSpec(1, 5, subplot_spec=gs)

        fontsize = 19
        colors = ['r', 'b']
        linestyle = '-'
        marker = 'o'
        labels = ['Annulus stimulus', 'Ring stimulus']
        ...
        x_ticks = [0]
        i = -3 
        while 2**(i-1) < max(radius):
            x_ticks.append(2**i)
            i = i+1

        if self.parameters.population:
            fr_ring = [numpy.mean(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='Firing rate').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in inner_radius]
            fr_disk = [numpy.mean(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='Firing rate').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in radius]
            fr_ring_std = [numpy.std(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='Firing rate').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in inner_radius]
            fr_disk_std = [numpy.std(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='Firing rate').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in radius]


        else:
            fr_ring = [queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='Firing rate').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx]) for r in inner_radius]
            fr_disk = [queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='Firing rate').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx]) for r in radius]
            fr_ring_std = [numpy.sqrt(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='Tria-to-trial Var of Firing rate').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx])) for r in inner_radius]
            fr_disk_std = [numpy.sqrt(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='Tria-to-trial Var of Firing rate').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx])) for r in radius]
        
        fr_ring.insert(0, fr_disk[-1])
        fr_disk.insert(0, fr_ring[-1])
        fr_ring_std.insert(0, fr_disk_std[-1])
        fr_disk_std.insert(0, fr_ring_std[-1])

        xs = []
        ys = []
        errors = []
        xs.append(inner_radius_plot)
        ys.append(numpy.array(fr_ring))
        errors.append(fr_ring_std)
        
        xs.append(radius_plot)
        ys.append(numpy.array(fr_disk))
        errors.append(fr_disk_std)

        plots.append(("Size tuning firing rate",StandardStyleLinePlot(xs, ys,error=errors), gs[0], {'labels': labels, 'x_lim': (radius_plot.min(), radius_plot.max()), 'y_lim': (0, 8), 'x_scale_base': 2, 'x_scale_linthresh': 0.125, 'x_scale_linscale': 0.5, 'x_label' :'Diameter', 'y_label' :'Firing Rate', 'legend': False, 'errorbars': True, 'colors': colors, 'linestyles': linestyle, 'markers': marker, 'x_scale': 'symlog', 'x_ticks': x_ticks}))

        if self.parameters.population:
            vm_ring = [numpy.mean(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='Mean(VM)').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in inner_radius]
            vm_disk = [numpy.mean(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='Mean(VM)').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in radius]
            vm_ring_std = [numpy.std(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='Mean(VM)').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in inner_radius]
            vm_disk_std = [numpy.std(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='Mean(VM)').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in radius]


        else:
            vm_ring = [queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='Mean(VM)').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx]) for r in inner_radius]
            vm_disk = [queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='Mean(VM)').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx]) for r in radius]
            vm_ring_std = [queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='STD(Mean(VM))').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx]) for r in inner_radius]
            vm_disk_std = [queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='STD(Mean(VM))').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx]) for r in radius]

        vm_ring.insert(0, vm_disk[-1])
        vm_disk.insert(0, vm_ring[-1])
        vm_ring_std.insert(0, vm_disk_std[-1])
        vm_disk_std.insert(0, vm_ring_std[-1])
        ...
        plots.append(("Size Tuning membrane potential DC",StandardStyleLinePlot(xs, ys,error=errors), gs[1], {'labels': labels, 'x_lim': (radius_plot.min(), radius_plot.max()), 'y_lim': (-72, -64), 'x_scale_base': 2, 'x_scale_linthresh': 0.125, 'x_scale_linscale': 0.5, 'x_label' :'Diameter', 'y_label' :'VmDC', 'legend': False, 'errorbars': True, 'colors': colors, 'linestyles': linestyle, 'markers': marker, 'x_scale': 'symlog', 'x_ticks': x_ticks}))

        if self.parameters.population:
            vm_ring_stdv = [numpy.mean(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='Trial-to-Trial STD of VM').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in inner_radius]
            vm_disk_stdv = [numpy.mean(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='Trial-to-Trial STD of VM').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in radius]
            vm_ring_stdv_std = [numpy.std(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='Trial-to-Trial STD of VM').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in inner_radius]
            vm_disk_stdv_std = [numpy.std(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='Trial-to-Trial STD of VM').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in radius]

        else:
            vm_ring_stdv = [queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='Trial-to-Trial STD of VM').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx]) for r in inner_radius]
            vm_disk_stdv = [queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='Trial-to-Trial STD of VM').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx]) for r in radius]


        vm_ring_stdv.insert(0, vm_disk_stdv[-1])
        vm_disk_stdv.insert(0, vm_ring_stdv[-1])
        ys = []
        ys.append(numpy.array(vm_ring_stdv))
        ys.append(numpy.array(vm_disk_stdv))

        if self.parameters.population:
            vm_ring_stdv_std.insert(0, vm_disk_stdv_std[-1])
            vm_disk_stdv_std.insert(0, vm_ring_stdv_std[-1])
            errors = []
            errors.append(vm_ring_stdv_std)
            errors.append(vm_disk_stdv_std)
            plots.append(("Size Tuning membrane potential SDv",StandardStyleLinePlot(xs, ys, error=errors), gs[2], {'labels': labels, 'x_lim': (radius_plot.min(), radius_plot.max()), 'y_lim': (0, 5), 'x_scale_base': 2, 'x_scale_linthresh': 0.125, 'x_scale_linscale': 0.5, 'x_label' :'Diameter', 'y_label' :'VmSDv', 'legend': False, 'errorbars': True, 'colors': colors, 'linestyles': linestyle, 'markers': marker, 'x_scale': 'symlog', 'x_ticks': x_ticks}))
        else:
            plots.append(("Size Tuning membrane potential SDv",StandardStyleLinePlot(xs, ys), gs[2], {'labels': labels, 'x_lim': (radius_plot.min(), radius_plot.max()), 'y_lim': (0, 5), 'x_scale_base': 2, 'x_scale_linthresh': 0.125, 'x_scale_linscale': 0.5, 'x_label' :'Diameter', 'y_label' :'VmSDv', 'legend': False, 'errorbars': True, 'colors': colors, 'linestyles': linestyle, 'markers': marker, 'x_scale': 'symlog', 'x_ticks': x_ticks}))

        if self.parameters.population:
            vm_ring_stdh = [numpy.mean(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='Temporal STD of Vm').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in inner_radius]
            vm_disk_stdh = [numpy.mean(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='Temporal STD of Vm').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in radius]
            vm_ring_stdh_std = [numpy.std(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='STD of Temporal STD of Vm').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in inner_radius]
            vm_disk_stdh_std = [numpy.std(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='STD of Temporal STD of Vm').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in radius]

        else:
            vm_ring_stdh = [queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='Temporal STD of Vm').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx]) for r in inner_radius]
            vm_disk_stdh = [queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='Temporal STD of Vm').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx]) for r in radius]
            vm_ring_stdh_std = [queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='STD of Temporal STD of Vm').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx]) for r in inner_radius]
            vm_disk_stdh_std = [queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='STD of Temporal STD of Vm').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx]) for r in radius]

        vm_ring_stdh.insert(0, vm_disk_stdh[-1])
        vm_disk_stdh.insert(0, vm_ring_stdh[-1])
        vm_ring_stdh_std.insert(0, vm_disk_stdh_std[-1])
        vm_disk_stdh_std.insert(0, vm_ring_stdh_std[-1])

        ys = []
        errors = []

        ys.append(numpy.array(vm_ring_stdh))
        errors.append(vm_ring_stdh_std)

        ys.append(numpy.array(vm_disk_stdh))
        errors.append(vm_disk_stdh_std)

        plots.append(("Size Tuning membrane potential SDh",StandardStyleLinePlot(xs, ys, error=errors), gs[3], {'labels': labels, 'x_lim': (radius_plot.min(), radius_plot.max()), 'y_lim': (0, 5), 'x_scale_base': 2, 'x_scale_linthresh': 0.125, 'x_scale_linscale': 0.5, 'x_label' :'Diameter', 'y_label' :'VmSDh', 'legend': False, 'errorbars': True, 'colors': colors, 'linestyles': linestyle, 'markers': marker, 'x_scale': 'symlog', 'x_ticks': x_ticks}))

        if self.parameters.population:
            vm_ring_f1 = [numpy.mean(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='F1_Vm').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in inner_radius]
            vm_disk_f1 = [numpy.mean(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='F1_Vm').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in radius]
            vm_ring_f1_std = [numpy.std(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='F1_Vm').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in inner_radius]
            vm_disk_f1_std = [numpy.std(queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='F1_Vm').get_analysis_result()[0].get_value_by_id(self.parameters.neurons)) for r in radius]

        else:
            vm_ring_f1 = [queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingRing', st_direct_stimulation_name=None, st_inner_aperture_radius = r, sheet_name = self.parameters.sheet_name, value_name='F1_Vm').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx]) for r in inner_radius]
            vm_disk_f1 = [queries.param_filter_query(self.datastore, st_name='DriftingSinusoidalGratingDisk', st_direct_stimulation_name=None, st_radius = r, sheet_name = self.parameters.sheet_name, value_name='F1_Vm').get_analysis_result()[0].get_value_by_id(self.parameters.neurons[idx]) for r in radius]

        vm_ring_f1.insert(0, vm_disk_f1[-1])
        vm_disk_f1.insert(0, vm_ring_f1[-1])


        ys = []
        ys.append(numpy.array(vm_ring_f1))
        ys.append(numpy.array(vm_disk_f1))

        if self.parameters.population:
            vm_ring_f1_std.insert(0, vm_disk_f1_std[-1])
            vm_disk_f1_std.insert(0, vm_ring_f1_std[-1])
            errors = []
            errors.append(vm_ring_f1_std)
            errors.append(vm_disk_f1_std)
            plots.append(("Size Tuning membrane potential F1",StandardStyleLinePlot(xs, ys, error=errors), gs[4], {'labels': labels, 'x_lim': (radius_plot.min(), radius_plot.max()), 'y_lim': (0, 10), 'x_scale_base': 2, 'x_scale_linthresh': 0.125, 'x_scale_linscale': 0.5, 'x_label' :'Diameter', 'y_label' :'VmF1', 'legend': False, 'errorbars': True, 'colors': colors, 'linestyles': linestyle, 'markers': marker, 'x_scale': 'symlog', 'x_ticks': x_ticks}))
        else:
            plots.append(("Size Tuning membrane potential F1",StandardStyleLinePlot(xs, ys), gs[4], {'labels': labels, 'x_lim': (radius_plot.min(), radius_plot.max()), 'y_lim': (0, 10), 'x_scale_base': 2, 'x_scale_linthresh': 0.125, 'x_scale_linscale': 0.5, 'x_label' :'Diameter', 'y_label' :'VmF1', 'legend': False, 'errorbars': True, 'colors': colors, 'linestyles': linestyle, 'markers': marker, 'x_scale': 'symlog', 'x_ticks': x_ticks}))
